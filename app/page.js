  ...
  return (
    <div className={`min-h-screen bg-white overflow-x-hidden ${raleway.variable} ${inter.variable}`}>
      ...
      <header className="container mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center relative">
        <div className="mb-4 md:mb-0 self-start w-full md:w-auto">
          <img className="w-[150px] md:w-[200px] h-auto" src="logo.png" alt="Logo" />
        </div>
        ...
        >
          <div className={`w-6 h-0.5 bg-black mb-1.5 transition-all ${mobileMenuOpen ? 'rotate-45 translate-y-2' : ''}`}></div>
          <div className={`w-6 h-0.5 bg-black mb-1.5 transition-all ${mobileMenuOpen ? 'opacity-0' : 'opacity-100'}`}></div>
        ...
        <div className="hidden md:flex md:flex-row items-center gap-8">
          <nav className="flex items-center gap-14 mb-0">
            <div className="text-black text-lg font-bold font-raleway underline">Home</div>
            <div className="text-[#8a8a8a] text-lg font-bold font-raleway">About</div>
            <div className="text-[#8a8a8a] text-lg font-bold font-raleway">Services</div>
          </nav>
          
          <div className="bg-black rounded-[10px] px-4 py-2 inline-flex justify-center items-center">
            <div className="text-white text-lg font-normal font-raleway">Contact us</div>
          </div>
        </div>
        
        {/* Mobile Menu Overlay */}
        <div className={`fixed inset-0 bg-white z-40 transition-all duration-300 md:hidden
                       ${mobileMenuOpen ? 'opacity-100 visible' : 'opacity-0 invisible'}`}>
          <div className="flex flex-col items-center justify-center h-full space-y-8">
            <nav className="flex flex-col items-center gap-8">
              <div className="text-black text-xl font-bold font-raleway underline">Home</div>
              <div className="text-[#8a8a8a] text-xl font-bold font-raleway">About</div>
              <div className="text-[#8a8a8a] text-xl font-bold font-raleway">Services</div>
            </nav>
            
            <div className="bg-black rounded-[10px] px-6 py-3 inline-flex justify-center items-center mt-8">
              <div className="text-white text-lg font-normal font-raleway">Contact us</div>
            </div>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-8 md:py-16">
        <div className="mb-8 md:mb-16">
          <h1 className="text-4xl md:text-6xl font-bold font-raleway capitalize mb-6 text-black">
      ...
      <section className="bg-[#0b0b0b] py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-7xl font-bold font-raleway text-white mb-6">About us</h2>
        
          <div className="text-justify mt-8">
            <p className="text-white text-base md:text-xl font-normal font-raleway leading-relaxed">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-7xl font-bold font-raleway text-[#ff360d] mb-12">Services</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-black mb-8 md:mb-0">
              ...
              <p className="text-xl md:text-2xl font-medium font-raleway leading-loose">
            ...
            <div className="col-span-1 md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {/* Card 2 */}
              <div className="bg-[#dedede] rounded-[20px] p-6">
                <div className="flex flex-col gap-3">
                  <div className="relative">
                    <svg width="50" height="51" viewBox="0 0 50 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M14.5833 27.5833L5.20833 36.9583L14.5833 46.3333M5.20833 36.9667H23.4375M35.4167 19.25L44.7917 28.625L35.4167 38M44.7917 28.6333H26.5625M4.6875 25.5V8.3125H45.3125V16.125" stroke="#FF360E" strokeWidth="1.995" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </div>
                  <h3 className="text-[#ff360d] text-base md:text-lg font-bold leading-snug">Import & Export</h3>
                  <p className="text-black text-sm md:text-base font-normal leading-snug">
              ...
              <div className="bg-[#dedede] rounded-[20px] p-6">
                <div className="flex flex-col gap-3">
                  ...
                  <h3 className="text-[#ff360d] text-base md:text-lg font-bold leading-snug">Airfreight</h3>
                  <p className="text-black text-sm md:text-base font-normal leading-snug">
              ...
              <div className="bg-[#dedede] rounded-[20px] p-6">
                <div className="flex flex-col gap-3">
                  ...
                  <h3 className="text-[#ff360d] text-base md:text-lg font-bold leading-snug">LCL (Less than Container Load)</h3>
                  <p className="text-black text-sm md:text-base font-normal leading-snug">
