            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="col-span-1 md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-[#dedede] rounded-[20px] shadow p-6 transition-all duration-300 hover:shadow-lg hover:scale-105 hover:bg-[#ff360d] cursor-pointer group">
                  <div className="flex flex-col gap-3">
                    <div className="relative">
                      <svg width="30" height="30" viewBox="0 0 50 51" fill="none" xmlns="http://www.w3.org/2000/svg" className="stroke-[#ff360d] group-hover:stroke-white">
                ...
                <div className="bg-[#dedede] rounded-[20px] p-6 transition-all duration-300 hover:shadow-lg hover:scale-105 hover:bg-[#ff360d] cursor-pointer group">
                  <div className="flex flex-col gap-3">
                    <div className="relative">
                      <svg width="30.5" height="30.5" viewBox="0 0 50 51" fill="none" xmlns="http://www.w3.org/2000/svg" className="stroke-[#ff360d] group-hover:stroke-white">
                ...
                <div className="bg-[#dedede] rounded-[20px] p-6 transition-all duration-300 hover:shadow-lg hover:scale-105 hover:bg-[#ff360d] cursor-pointer group">
                  <div className="flex flex-col gap-3">
                    <div className="relative group-hover:text-white">
                      <svg className="group-hover:[&_path]:fill-white" width="30.5" height="30.5" viewBox="0 0 54 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="bg-[#dedede] rounded-[20px] p-6 transition-all duration-300 hover:shadow-lg hover:scale-105 hover:bg-[#ff360d] cursor-pointer group">
                  <div className="flex flex-col gap-3">
                    <div className="relative">
                      <svg className="group-hover:[&_rect]:stroke-white group-hover:[&_rect]:fill-transparent group-hover:[&_rect:nth-child(2)]:fill-white" width="30.5" height="30.5" viewBox="0 0 50 51" fill="none" xmlns="http://www.w3.org/2000/svg">
